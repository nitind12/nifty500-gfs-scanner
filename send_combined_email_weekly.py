"""
Send ONE weekly email containing only scanners with real eligible data.
...
def main():
    ...
    body_lines = [
        "Weekly scan run complete. Only scanners with eligible results are attached:\n",
    ]
    ...
    try:
        ...
        print(f"Weekly email sent to {RECIPIENT_EMAIL} with {len(csv_files)} attachment(s).")
